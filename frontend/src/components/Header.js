  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0f0f10]/95 backdrop-blur-lg border-b border-[#ff8800]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-[#ff8800]/10 hover:bg-[#ff8800]/20 text-[#ff8800] transition-colors duration-300"
        ...
        {/* Mobile Navigation */}
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-[#ff8800]/20">
